...
?>
	...
	<input onClick="goAction('quotepdf.php');" class="btn btn-danger" id="quotepdf" name="quotepdf"  value="PDF Report">
	</div>
	</div>
        ...
        <div class="col-sm-4 Padding-remove-left">
            ...
            <div class=" input-group">
                ...
                <select id="mySelect" class="form-control" name="Destination">
                    <option value="Please Select" >Please Select</option>
                    <option <?php if ($Destination == "Inchen"){echo "selected='selected'";} ?> value="Inchen" >Inchen</option>
